...
<!-- This work is in the public domain and may be reproduced, published or 
	...
	(NLM). We request only that the NLM is cited as the source of the work. Although 
	all reasonable efforts have been taken to ensure the accuracy and reliability 
	of the software and data, the NLM and the U.S. Government do not and cannot 
	warrant the performance or results that may be obtained by using this software 
	or data. The NLM and the U.S. Government disclaim all warranties, express 
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="processes">
		...
		<step>../../xslt/oasis-tables/oasis-table-html-NPG-fixed.xsl</step>

		<!-- convert into HTML for display -->
		<step>../../xslt/main/jats-html-NPG-fixed.xsl</step>
	</xsl:variable>
